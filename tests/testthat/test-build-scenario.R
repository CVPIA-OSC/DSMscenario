...
test_that("spawn degrade and add works", {
  ...
  expect_lt(updated_inputs$spawning_habitat["Antelope Creek", "Jan", "1982"],
  ...
  degrade_ratio <- updated_inputs$spawning_habitat["Antelope Creek", "Jan", "1982"]/
    habitat_inputs$spawning_habitat["Antelope Creek", "Jan", "1982"]

  # decay rate is runif(min = watershed spawn decay rate, max = 1)
  expect_gte(degrade_ratio, DSMscenario::spawn_decay_rate[["Antelope Creek"]])
...
test_that("inchannel degrade and add works", {
  ...
  expect_lt(updated_inputs$inchannel_habitat_fry["Antelope Creek", "Jan", "1982"],
  ...
  expect_lt(updated_inputs$inchannel_habitat_juvenile["Antelope Creek", "Jan", "1982"],
            habitat_inputs$inchannel_habitat_juvenile["Antelope Creek", "Jan", "1982"])
  ...
  degrade_ratio <- updated_inputs$inchannel_habitat_fry["Antelope Creek", "Jan", "1982"]/
    habitat_inputs$inchannel_habitat_fry["Antelope Creek", "Jan", "1982"]

  # decay rate is runif(min = watershed spawn decay rate, max = 1)
  expect_gte(degrade_ratio, DSMscenario::rear_decay_rate[["Antelope Creek"]])
  expect_lte(degrade_ratio, 1)

  degrade_ratio <- updated_inputs$inchannel_habitat_juvenile["Antelope Creek", "Jan", "1982"]/
    habitat_inputs$inchannel_habitat_juvenile["Antelope Creek", "Jan", "1982"]
